...
default coughDrop = 0
default earmuffs = 0
define jeff = Character("Jeff", color = "#ffcc00")
define merchant = Character("Merchant Molluck", color = "#0020FF")
define villageB = Character("Bandlewood Villagers", color = "#10FF10")
define merchant2 = Character("Mistress Hilda", color = "#ffa07a")
define creature = Character("Shrill", color = "#2e8b57")
define villageC = Character("Hermit Cove Citizens", color = "#FF00FF")
label start:
    scene forest1
    pause
...
label market2:
    ...
    menu:
        "Why is that?":
            merchant2 "Well [you], simply put they all put out of business, can't compete anymore. I myself have had this shop for 30 years, but only travellers come here now."
            jump sellitem1
